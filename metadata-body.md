...
The 18-month working budget allocates across seven lines: Farmer Growth (AE programmes), Satellite Data and Extensible Oracle Infrastructure, Info Trust Layer (core build), Cardano dApp Integration, On-Chain Transaction Costs, Foundation Support, and a combined Admin & Audit allocation covering Intersect's standard administration fee and a separately procured independent third-party assurer. Detailed line-by-line breakdown is in the public PDF referenced below.

The 10,000,000 ADA ask sits well within the ratified 350,000,000 ADA Net Change Limit (approximately 2.86% of the cap). If a surplus arises against the hard cap, the Foundation retains up to $3.5M for scope elasticity within existing objectives; surplus above $3.5M returns to the Treasury.

ADA-price-movement policy: the 10,000,000 ADA cap is hard, with no top-up ask if ADA falls. If ADA rises against USD, surplus above $3.5M returns to Treasury. If ADA falls, we cut scope before going back to Treasury — discretionary reporting first, infrastructure second, lower-priority work packages third, and programme duration only as a last resort.
...
* [Final proposal PDF](https://raw.githubusercontent.com/5am-earth/cardano-budget-2026/main/proposal-final.pdf)
* [Proposal source markdown](https://raw.githubusercontent.com/5am-earth/cardano-budget-2026/main/proposal-final.md)
* [Cardano Catalyst Fund 13 — Project Swaminathan baseline](https://projectcatalyst.io/funds/13/cardano-open-developers/satellite-oracle-combining-earth-observation-data-with-cardano-based-blockchain-infrastructure-for-smallholder-farmers)
* [Project Swaminathan on-chain address (CardanoScan)](https://cardanoscan.io/address/01e9b56233ca537ab6b3096e886f4a54fbd2fb92b4b3bf52d8e1e71c2a83c16d3d0350fd7927937389b91419299f913ee8515168ab3fa6e5dd)

## Authors

* Yoram Ben-Zvi (Elk GMBH)
* Shay Gammer (HashPoint Consulting Sarl)
